        ...
        db.run(`CREATE TABLE bakedgoodsdata (
            ...
            (err) => {
                if (err) {
                    ...
                    db.run(insert, [24, '103', 'Reeses Cups', "The classic combination of chocolate and peanut butter, REESE'S Peanut Butter Cups are the perfect companion for movies, sports and parties",'Sarah P', '1.75', '11229'])
                    db.run(insert, [25, '103', 'Strawberry Cheesecake', 'Bright, beautiful, and luscious Strawberry Cheesecake. This silky smooth cheesecake has a layer of easy homemade strawberry spread on the bottom and then a swirl of it through the top. Fresh strawberry flavors with creamy cheesecake is a perfect pair','Claire S', '7.95', '11229'])
                }
            })
